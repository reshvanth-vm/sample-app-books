...
import com.example.books.feature.user.profile.create.CreateProfileFragment
...
class LoginFragment : BaseFragment(),
  ...
  companion object {
    const val TAG = "user_login_screen"
  }
  ...
  override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
    ...
    ViewCompat.setWindowInsetsAnimationCallback(binding.root, WindowInsetsAnimationCompatCallback())
  ...
  override fun signUp(btn: View) {
    ...
    val transitionName = resources.getString(R.string.login_card_container_transition_name)
    parentFragmentManager.commit {
      setReorderingAllowed(true)
      addSharedElement(binding.containerCardView, transitionName)
